@AbapCatalog.sqlViewName: 'ZV_BOOKING_EOU'
...
//add 'root' after define to add transactional behaviour
define root view ZI_Booking_Eou
  as select from ztbooking_eou as Booking
